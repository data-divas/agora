...
Revision ID: f1bc7b55207c
Revises: 
Create Date: 2026-01-31 14:07:19.250826
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_users_privy_did'), 'users', ['privy_did'], unique=False)
