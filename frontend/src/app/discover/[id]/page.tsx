...
function DetailSection({
  ...
  return (
    <section className="rounded-xl border border-white/10 bg-white/20 p-5 shadow-sm backdrop-blur-xl">
  ...
  return (
    <div className="flex min-h-screen bg-[#FAFAFA]">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        {/* Hero */}
        <header className="border-b border-white/10 bg-white/20 px-6 py-6 backdrop-blur-xl">
          <button
            type="button"
            onClick={() => router.back()}
          ...
          <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-5">
            ...
            <div className="space-y-6 lg:col-span-3">
              ...
              <DetailSection title="Next steps">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    href="/discover"
                    className="rounded-lg border border-white/20 bg-white/20 px-4 py-2.5 text-sm font-medium text-[#1a1a1a] hover:bg-white/40 transition-colors backdrop-blur-xl"
                  >
                    Back to Discover
                  </Link>
                </div>
            ...
            <div className="lg:col-span-2">
              <div className="sticky top-6 space-y-3">
                <div className="h-[380px] overflow-hidden rounded-xl border border-white/10 bg-white/10 shadow-sm backdrop-blur-xl">
                  <DiscoverMap
                    lots={[detail]}
                    selectedLot={detail}
                    onSelectLot={() => {}}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block rounded-lg border border-white/20 bg-white/20 px-4 py-2.5 text-center text-sm font-medium text-[#1a1a1a] hover:bg-white/40 transition-colors backdrop-blur-xl"
                >
                  Open in Google Maps
                </a>
              </div>
